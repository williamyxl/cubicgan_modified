...
# exit(arr_lengths)
    ...
    for i in range(n_samples):
        ...
        os.makedirs(os.path.join('generated_mat', 'sample-%d'%(int(FLAGS.n_samples)), 'generated-cifs'), exist_ok=True)
        os.makedirs(os.path.join('generated_mat', 'sample-%d'%(int(FLAGS.n_samples)), 'tmp-symmetrized-cifs'), exist_ok=True)
        os.makedirs(os.path.join('generated_mat', 'sample-%d'%(int(FLAGS.n_samples)), 'tmp-charge-cifs'), exist_ok=True)
